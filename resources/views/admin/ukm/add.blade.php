...
@section('content')
    <div class="card">
        ...
        <form action="{{route('simpan_ukm')}}" method="POST">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <label for="inpukNama">Nama UKM</label>
                    <input id="inputNama" type="text" name="nama_ukm" class="form-control" required placeholder="Masukan Nama UKM...">
                </div>
                <div class="form-group">
                    <label for="inpukNama">Penanggung Jawab</label>
                    <input id="nama_pj" type="text" name="nama" class="form-control" required placeholder="Masukan Penanggung Jawab UKM...">
                    <input required class="form-control" type="hidden" name="penanggung_jawab_ukm" id="id_pj_ukm">
                </div>
            </div>
