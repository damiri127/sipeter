...
<div class="card">
    ...
    <div class="formulir_rekammedis">
        <form action="/poliumum/datakunjungan/update/{{ $pasien->id_kunjungan }}" method="POST">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select name="opsiRujukan" class="form-control" id="opsiRujukan" aria-placeholder="Pilih Status Rujukan untuk Pasien" required>
                        <option value="#">Pilih Rujukan</option>
                        <option value="rujukan_internal">Rujukan Internal</option>
                        <option value="rujukan_ekstrnal">Rujukan Eksternal</option>
                        <option value="tidak_dirujuk">Tidak Perlu</option>
                    </select>
                </div>
            </div>
